...
describe("test processAdvanceRates", () => {
  ...
  it("accepts multiple parameters and returns beginning and ending advance rates for each collateral in facility for time period (first lien/stated advance)", async () => {

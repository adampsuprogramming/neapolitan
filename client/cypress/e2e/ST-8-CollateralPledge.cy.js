...
it("submits a new collateral pledge form", function () {
  ...
  cy.get('#root div.css-1k0dehn div:nth-child(2)').contains("Test - The Donkey Kong Company").should("be.visible");
  cy.get('#root div.css-1k0dehn div:nth-child(4)').contains("Test - The Loan Agreement for Donkey Kong Co.").should("be.visible");
  cy.get('#root div:nth-child(6)').contains("Test - Loan Tranche for Donkey Kong Co").should("be.visible");
  ...
  cy.get('[data-testid="inclusion-date-picker"]').should(
    "not.have.value",
    "",
  );

...
it("submits a new borrower form", function () {
    ...
    cy.get('div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div > button > [data-testid="ArrowDropDownIcon"] > path').click();
    ...
    cy.get('#autocomplete-naics-subsector-option-29').click();
    cy.get('#autocomplete-naics-subsector').should("have.value", "Electrical Equipment, Appliance, and Component Manufacturing");
